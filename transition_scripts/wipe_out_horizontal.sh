#!/bin/bash
#
# ffmpeg video slideshow script with horizontal wipe out transition v2 (04.12.2018)
#
...
# 9. END
FULL_SCRIPT+=" -map [video] -vsync 2 -async 1 -rc-lookahead 0 -g 0 -profile:v main -level 42 -c:v libx264 -r ${FPS} ../transition_wipe_out_horizontal.mp4"
