#!/bin/bash
#
# ffmpeg video slideshow script with vertical box in transition v1 (28.06.2018)
#
...
[5:v][stream1prephasein]overlay=x=0:y='720-720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream1phasein];\
[5:v][stream2prephasein]overlay=x=0:y='720-720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream2phasein];\
[5:v][stream3prephasein]overlay=x=0:y='720-720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream3phasein];\
[5:v][stream4prephasein]overlay=x=0:y='720-720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream4phasein];\
[5:v][stream5prephasein]overlay=x=0:y='720-720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream5phasein];\
[5:v][stream1prephaseout]overlay=x=0:y='720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream1phaseout];\
[5:v][stream2prephaseout]overlay=x=0:y='720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream2phaseout];\
[5:v][stream3prephaseout]overlay=x=0:y='720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream3phaseout];\
[5:v][stream4prephaseout]overlay=x=0:y='720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream4phaseout];\
[5:v][stream5prephaseout]overlay=x=0:y='720*t/0.5',trim=duration=0.5,select=lte(n\,15)[stream5phaseout];\
...
concat=n=35:v=1:a=0,format=yuv420p[video]"\
 -map [video] -vsync 2 -async 1 -rc-lookahead 0 -g 0 -profile:v main -level 42 -c:v libx264 -r 30 ../transition_box_in_vertical.mp4
