#!/bin/bash
#
# ffmpeg video slideshow script with clock transition v4 (25.05.2019)
#
...
TOTAL_DURATION=$(( (IMAGE_DURATION+CONSTANT_TRANSITION_DURATION)*IMAGE_COUNT - CONSTANT_TRANSITION_DURATION ))
