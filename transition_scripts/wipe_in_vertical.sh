#!/bin/bash
#
# ffmpeg video slideshow script with vertical wipe in transition v1 (01.10.2017)
#
...
[stream1ending][stream2starting]overlay=y='-h+t/1*720':x=0,select=lte(n\,30)[stream2blended];\
[stream2ending][stream3starting]overlay=y='-h+t/1*720':x=0,select=lte(n\,30)[stream3blended];\
[stream3ending][stream4starting]overlay=y='-h+t/1*720':x=0,select=lte(n\,30)[stream4blended];\
[stream4ending][stream5starting]overlay=y='-h+t/1*720':x=0,select=lte(n\,30)[stream5blended];\
