#!/bin/bash
#
# ffmpeg video slideshow script with horizontal bars #1 transition v4 (25.05.2019)
#
...
# 9. END
FULL_SCRIPT+=" -map [video] -vsync 2 -async 1 -rc-lookahead 0 -g 0 -profile:v main -level 42 -c:v libx264 -r ${FPS} ../transition_bars_horizontal_one.mp4"
