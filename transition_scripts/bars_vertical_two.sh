#!/bin/bash
#
# ffmpeg video slideshow script with vertical bars #2 transition v2 (04.12.2018)
#
...
PHOTO_DURATION=2
BAR_COUNT=10            # WIDTH SHOULD BE DIVISIBLE BY BAR_COUNT. IF NOT VERTICAL LINES MAY APPEAR ON TRANSITION
