#!/bin/bash
#
# ffmpeg video slideshow script for advanced logo overlay v1 (01.10.2017)
#
...
-loop 1 -i ../objects/video-camera.png \
-filter_complex "\
...
[5:v]setpts=PTS-STARTPTS,scale=120:120,setsar=sar=1/1,format=rgba,trim=duration=1[logo];\
[videowithoutlogo][logo]overlay=x=950:y=550,trim=duration=15,select=lte(n\,450)[video]"\
