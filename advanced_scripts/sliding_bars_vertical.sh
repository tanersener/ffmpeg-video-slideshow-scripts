#!/bin/bash
#
# ffmpeg video slideshow script with advanced vertical sliding bars v2 (03.12.2018)
#
...
PHOTO_DURATION=2
BAR_COUNT=5             # WIDTH SHOULD BE DIVISIBLE BY BAR_COUNT. IF NOT VERTICAL LINES WILL APPEAR ON TRANSITION
