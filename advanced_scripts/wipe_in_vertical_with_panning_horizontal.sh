...
-filter_complex "\
[0:v]setpts=PTS-STARTPTS,scale=-1:360*2,setsar=sar=1/1,format=rgba,split=2[stream1out1][stream1out2];\
[1:v]setpts=PTS-STARTPTS,scale=-1:360*2,setsar=sar=1/1,format=rgba,split=3[stream2out1][stream2out2][stream2out3];\
